...
<VerifyNote lastVerified="2026-08-08" source="https://www.anthropic.com/engineering/effective-harnesses-for-long-running-agents">
...
- [Agent Runtimes: Isolates vs Containers](/docs/frontiers/agent-runtimes-isolates-vs-containers) — the compute primitive the harness runs on
