...
For background on the model itself see [GPT-6 Astra: the field guide for Claude users](/docs/models/openai-astra-preview). Update, September 2026: Astra shipped GA on September 4, 2026 as the first OpenAI model classified Critical for cyber, with exploit capability gated behind a vetted-access program; the field guide covers what that looks like in the released product.
