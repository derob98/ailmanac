...
- **When in doubt, we point at [the official docs](https://platform.claude.com/docs)** instead of copying a value. A link to a maintained source has a much longer half-life than a number pasted into a paragraph.
