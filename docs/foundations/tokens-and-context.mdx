...
<VerifyNote lastVerified="2026-08-22" source="https://arxiv.org/abs/2307.03172">The "lost in the middle" effect — degraded use of information placed mid-context — was documented by Liu et al. (2023). Newer long-context models handle it better, but the practical habit below still pays off.</VerifyNote>
...
- [Prompting for Long Context](/docs/prompting/long-context) — where to place documents, how to tag them, and the quote-extraction trick
