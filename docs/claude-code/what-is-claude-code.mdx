...
<VerifyNote lastVerified="2026-08-21" source="https://code.claude.com/docs/en/overview">
...
- **Cloud sessions** — kicked off from claude.ai, mobile, or `claude --cloud`, running on Anthropic's infrastructure by default; Team and Enterprise plans can point them at [self-hosted runners inside their own network](/docs/claude-code/self-hosted-environments) instead.
