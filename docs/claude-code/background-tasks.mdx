...
<VerifyNote lastVerified="2026-07-15" source="https://code.claude.com/docs/en">
...
- [Auto-Commit Background Agents: Draft-PR Handoff](/docs/claude-code/auto-commit-background-agents) — what happens when a background session finishes
