...
- [Projects: The Coordinator & Parallel Threads](/docs/claude-code/projects-coordinator-threads) — the layer above: Claude decides the split and runs each piece as its own cloud session
