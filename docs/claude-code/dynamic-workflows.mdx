...
<VerifyNote lastVerified="2026-06-24" source="https://code.claude.com/docs/en/workflows">
Dynamic workflows are a fast-moving research-preview feature: the trigger keyword, approval options, agent caps, and availability change between Claude Code releases — confirm specifics in the official docs.
</VerifyNote>
