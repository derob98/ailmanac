...
- [Supabase Evals — Real-Backend Agent Benchmark](/docs/models/supabase-evals-agent-benchmark) — a shipped example of what a real-container coding-agent eval looks like end-to-end (Apache-2.0).
