...
- Related pages here: [Mid-Conversation Tool Changes](/docs/api/mid-conversation-tool-changes) · [Prompt Caching & Cost Optimization](/docs/api/prompt-caching) · [Building Agents on the API](/docs/api/building-agents) · [Tool Use](/docs/api/tool-use) · [Refusals & Safety](/docs/api/refusals-and-safety)

## Next

- [Mid-Conversation Tool Changes](/docs/api/mid-conversation-tool-changes) — the same idea, applied to the `tools` array (Opus 5 beta)
