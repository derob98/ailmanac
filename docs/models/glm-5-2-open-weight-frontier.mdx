...
- [Colibrì: run GLM-5.2 from your SSD on 16–24 GB of RAM](/docs/models/colibri-stream-frontier-moe-from-ssd)
- [Inkling: Thinking Machines' Open-Weights Model](/docs/models/inkling-thinking-machines)
