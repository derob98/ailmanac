...
<VerifyNote lastVerified="2026-08-26" source="https://platform.claude.com/docs/en/models/overview">
...
- [Local Agent or Claude? A Decision Guide](/docs/models/local-or-claude-agent)
