...
- [Gemini 3.8 Live and Live Extended Thinking](/docs/models/gemini-3-8-live-voice-agents) — building on Google's September 2026 voice models: async tools, session limits, real call costs
