...
<VerifyNote lastVerified="2026-09-21" source="https://platform.claude.com/docs/en/models/overview">
...
- [AI Gateways: LiteLLM, OpenRouter, Portkey, Vercel](/docs/models/ai-gateways-litellm-openrouter-portkey)
