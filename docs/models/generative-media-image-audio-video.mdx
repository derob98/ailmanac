...
- MiniMax H3 / Hailuo 3.0 — https://huggingface.co/MiniMaxAI/MiniMax-H3 · deep dive: [MiniMax H3 open-weight omni video model](/docs/models/minimax-h3-open-video-model)
- Pika — https://pika.art/
...
- [MiniMax H3 (Hailuo 3.0): The Open-Weight Omni Video Model](/docs/models/minimax-h3-open-video-model)
- [AI explainer videos: the code-driven pipeline](/docs/models/ai-explainer-videos-code-driven) — the other way to make video: a coding model writes a deterministic animation program, so text stays sharp, numbers stay correct, and you can re-render after an edit
