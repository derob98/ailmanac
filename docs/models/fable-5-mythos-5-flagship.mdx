...
| The workhorse: balanced quality, 1M context, cheap enough to run everywhere         | **Claude Sonnet 5**  | Default in Claude Code; often within striking distance of Opus quality at a fraction of the cost.           |
