...
<VerifyNote lastVerified="2026-07-31" source="https://platform.claude.com/docs/en/about-claude/models/introducing-claude-fable-5-and-claude-mythos-5">
Model IDs, pricing and behavior verified against Anthropic's official model page on 31 July 2026. Fable 5 `claude-fable-5` and Mythos 5 `claude-mythos-5` share the same specs: 1M-token context by default, up to 128K max output, $10 / $50 per MTok. 30-day data retention, not available under zero data retention. GA on Claude API, Amazon Bedrock, Claude Platform on AWS, Google Cloud and Microsoft Foundry from 9 June 2026. Cross-check the [Current Models & Pricing](/docs/whats-new/models-and-pricing) table before pinning a model.
</VerifyNote>
...
| The workhorse: balanced quality, 1M context, cheap enough to run everywhere         | **Claude Sonnet 5**  | Claude Code's default on Pro and Team Standard (Opus 5 is the default on Max, Team Premium, Enterprise and the API); often within striking distance of Opus quality at a fraction of the cost. See the [Sonnet 5 field guide](/docs/models/sonnet-5-field-guide) for the migration gotchas. |
...
- [Claude Fable 5.1: What Changed and How to Migrate](/docs/models/fable-5-1-field-guide) — the September 1, 2026 successor; three breaking changes on top of everything here
