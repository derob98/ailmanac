...
Skill layout and discovery can change — confirm against the official Skills docs. `name` in frontmatter is optional (defaults to the folder name); only `description` is recommended.
</VerifyNote>
