...
**Jump to your stack:** [Universal](#universal-starter) · [Node / TypeScript](#node--typescript-web-app) · [Python / FastAPI](#python-service) · [Django](#django) · [Go](#go) · [Rust](#rust)
...
- [Skill Packs & SKILL.md Templates](/docs/templates/skills)
