...
<!-- Go-specific: covers the module/package boundary rule, the error-handling
     contract, and the no-ORM default — the three places Claude drifts hardest
     without explicit instruction in a Go codebase. -->
