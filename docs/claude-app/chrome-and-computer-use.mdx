...
- [Computer-Use Agents Compared](/docs/models/computer-use-agents) — building your own: the Claude/GPT/Gemini APIs, the coordinate bug that breaks most first attempts, and how to read OSWorld honestly
