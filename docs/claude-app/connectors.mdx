...
- [Claudeforce: Salesforce in Claude](/docs/claude-app/claudeforce-salesforce-in-claude) — a real-world plugin that turns the 4-tool MCP pattern into 37 sales skills
