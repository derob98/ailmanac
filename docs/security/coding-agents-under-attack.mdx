...
See [Hardening Autonomous Runs](/docs/security/hardening-autonomous-runs) for the full unattended-run checklist and [Securing Agents & Tools](/docs/security/securing-agents) for scoping capabilities. For the **CI-runner** variant of this class — the Black Hat 2026 disclosures where a stranger's GitHub issue reached CI workflow secrets — see [GitHub Issue → CI Secrets](/docs/security/github-issue-to-ci-secrets-blackhat-2026).
...
- [GitHub Issue → CI Secrets: The Black Hat 2026 Coding-Agent Attacks](/docs/security/github-issue-to-ci-secrets-blackhat-2026)
