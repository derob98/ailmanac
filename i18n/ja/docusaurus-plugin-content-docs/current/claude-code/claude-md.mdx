...
既存のドキュメントを複製するのではなく、取り込みましょう — 例えば、スタイルガイドを `@path/to/file` のインポートで参照すれば、信頼できる情報源が 1 つに保たれます。正確な構文は [公式メモリドキュメント](https://docs.anthropic.com/en/docs/claude-code/memory) を参照してください。
