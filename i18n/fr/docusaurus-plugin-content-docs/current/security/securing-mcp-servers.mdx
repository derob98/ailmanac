...
C'est l'erreur qui transforme un serveur MCP bien intentionné en proxy pour un attaquant. C'est le même [problème du député confus](/docs/security/securing-agents#the-confused-deputy-problem) issu de la sécurité des agents, affûté en une règle concrète.
