...
- [Claude Platform docs — Aperçu des modèles](https://platform.claude.com/docs/en/models/overview) — tables de tarification, IDs de snapshots, identifiants Bedrock/GCP, defaults d'effort
