...
1. Installez et authentifiez-vous (consultez la [documentation officielle](https://docs.anthropic.com/en/docs/claude-code/overview) pour les commandes actuelles).
