...
Obtenez les tarifs actuels sur la [page de tarification officielle](https://platform.claude.com/docs/en/docs/about-claude/pricing) — nous ne les codons pas en dur ici à dessein.
