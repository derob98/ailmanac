...
Les deux doivent aussi envoyer `anthropic-version: 2023-06-01` sur chaque requête (les requêtes de groupes et rôles personnalisés Claude Enterprise sont la seule exception — voir la [règle du header beta](#the-beta-header-rule) ci-dessous).
...
## La règle du header beta {#the-beta-header-rule}
