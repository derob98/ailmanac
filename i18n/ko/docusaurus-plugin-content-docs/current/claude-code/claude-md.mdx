...
기존 문서를 복제하지 말고 끌어오세요 — 예를 들어 스타일 가이드를 `@path/to/file` import로 참조하면 단일 출처가 유지됩니다. 정확한 구문은 [공식 메모리 문서](https://docs.anthropic.com/en/docs/claude-code/memory)를 참고하세요.
