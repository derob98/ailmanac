...
- **Nel dubbio, puntiamo alla [documentazione ufficiale](https://docs.anthropic.com)** invece di copiare un valore. Un link a una fonte mantenuta ha una mezza vita molto più lunga di un numero incollato in un paragrafo.
