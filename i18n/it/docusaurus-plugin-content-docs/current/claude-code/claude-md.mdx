...
Includi documenti esistenti invece di duplicarli — ad esempio fai riferimento alla tua guida di stile con un import `@path/to/file` così c'è un'unica fonte autorevole. Vedi la [documentazione ufficiale sulla memoria](https://code.claude.com/docs/en/memory) per la sintassi esatta.
