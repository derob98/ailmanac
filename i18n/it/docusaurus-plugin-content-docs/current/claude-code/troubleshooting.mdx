...
| Impostazioni che non vengono applicate, hook che non scattano, server MCP che non si caricano | [Isola la tua configurazione](#isolate-your-config) qui sotto |
...
| CPU o memoria elevate | [Memoria e CPU](#memory-and-cpu) qui sotto |
| Blocchi, freeze, mancate risposte | [Blocchi e freeze](#hangs-and-freezes) qui sotto |
| `Autocompact is thrashing` | [Thrashing della compattazione](#compaction-thrashing) qui sotto |
| La ricerca, `@file`, gli agent o le skill non trovano i file | [La ricerca non trova nulla](#search-finds-nothing) qui sotto |
| Riquadri, sbavature o glifi sbagliati nel terminale dell'IDE | [Testo illeggibile nel terminale](#garbled-terminal-text) qui sotto |
