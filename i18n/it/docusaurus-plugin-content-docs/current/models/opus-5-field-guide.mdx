...
- [Claude Platform docs — Models overview](https://platform.claude.com/docs/en/models/overview) — tabelle di pricing, ID di snapshot, identificatori Bedrock/GCP, default di effort
