...
- Correlato su AILmanac: [Qwen3.8-Max: il primo modello open-weight di classe Max (quando i pesi usciranno)](/docs/models/qwen3-8-max-open-weight-max) — il flagship Alibaba del 3 agosto 2026, doppie API OpenAI/Anthropic e la matematica della sparsità per un MoE da 2,4T
- Correlato su AILmanac: [Kimi K2 per gli utenti di Claude](/docs/models/kimi-k2-for-claude-users) — l'agente aperto da mille miliardi di parametri di Moonshot, in profondità
- Correlato su AILmanac: [GLM-5.2: modello di coding di frontiera open-weight](/docs/models/glm-5-2-open-weight-frontier) — il MoE da 753B di Z.ai che si avvicina a un punto da Claude Opus 4.8 sul coding a lungo orizzonte
- Correlato su AILmanac: [DeepSeek V4-Flash-Vision: il primo open weight di frontiera con visione nativa](/docs/models/deepseek-v4-flash-vision-open-multimodal) — 31 agosto 2026, eguaglia o batte Claude Opus 4.8 su diversi benchmark di agenti multimodali a circa 1/40 del prezzo per token di Opus


## Prossimi passi

- [MiMo-V2.6: il modello omnimodale open-weight da 1T di Xiaomi](/docs/models/mimo-v2-6-open-weight-omnimodal) — 22 settembre 2026: licenza MIT, 1,02T/42B attivi, testo+immagini+video+audio in ingresso
- [DeepSeek V4-Flash-Vision: il primo open weight di frontiera con visione nativa](/docs/models/deepseek-v4-flash-vision-open-multimodal)
- [Qwen3.8-Max: il primo modello open-weight di classe Max (quando i pesi usciranno)](/docs/models/qwen3-8-max-open-weight-max)
