...
Questo è l'errore che trasforma un server MCP ben intenzionato nel proxy di un attaccante. È lo stesso [problema del deputato confuso](/docs/security/securing-agents#the-confused-deputy-problem) della sicurezza degli agent, ridotto a un'unica regola concreta.
