...
Este é o erro que transforma um servidor MCP bem-intencionado no proxy de um atacante. É o mesmo [problema do delegado confuso](/docs/security/securing-agents) da segurança de agentes, afiado em uma única regra concreta.
