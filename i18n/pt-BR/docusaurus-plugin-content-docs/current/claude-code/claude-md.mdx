...
Traga documentos existentes em vez de duplicá-los — por exemplo, referencie seu guia de estilo com uma importação `@caminho/para/arquivo` para que haja uma única fonte da verdade. Veja a [documentação oficial de memória](https://code.claude.com/docs/en/memory) para a sintaxe exata.
