...
Veja a [documentação oficial](https://docs.anthropic.com/en/docs/claude-code/slash-commands) para a sintaxe exata de argumentos, bash e referências de arquivo.
