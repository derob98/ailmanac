...
<VerifyNote lastVerified="2026-06-28" source="https://platform.claude.com/docs/en/models/overview">
...
- [Anthropic — Resumen de los modelos Claude](https://platform.claude.com/docs/en/models/overview)
