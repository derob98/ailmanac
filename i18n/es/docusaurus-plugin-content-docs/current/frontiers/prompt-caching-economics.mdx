...
Las mecánicas de caché, los niveles de precios, las duraciones de TTL y los umbrales mínimos de tokens cambian a medida que Anthropic actualiza la plataforma. No te fíes de ningún número concreto de guías de terceros. Consulta siempre la [documentación oficial de almacenamiento en caché de prompts](https://docs.anthropic.com/en/docs/build-with-claude/prompt-caching) y la página de [Modelos y Precios](/docs/whats-new/models-and-pricing) para los valores actuales.
