...
Este es el error que convierte un servidor MCP bienintencionado en el proxy de un atacante. Es el mismo [problema del diputado confundido](/docs/security/securing-agents#the-confused-deputy-problem) de la seguridad de agentes, afinado a una única regla concreta.
