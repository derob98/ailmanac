...
Binde vorhandene Dokumente ein, statt sie zu duplizieren — referenziere z. B. deinen Styleguide mit einem `@path/to/file`-Import, sodass es eine einzige Quelle der Wahrheit gibt. Die genaue Syntax findest du in der [offiziellen Memory-Dokumentation](https://docs.anthropic.com/en/docs/claude-code/memory).
