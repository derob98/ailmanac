...
Das ist der Fehler, der einen wohlmeinenden MCP-Server in den Proxy eines Angreifers verwandelt. Es ist dasselbe [Problem des verwirrten Stellvertreters](/docs/security/securing-agents#the-confused-deputy-problem) aus der Agenten-Sicherheit, zugespitzt auf eine konkrete Regel.
