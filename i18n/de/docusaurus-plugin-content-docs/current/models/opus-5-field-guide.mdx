...
- [Claude Platform docs — Models overview](https://platform.claude.com/docs/en/models/overview) — Preistabellen, Snapshot-IDs, Bedrock/GCP-Identifiers, Effort-Defaults
